...
class TagController extends Controller
{
    ...
    public function show($id)
    {
        ...
        return $tag->response()->setStatusCode(200, "Tag Returned Succefully")->header('Additional Header', 'True');
    }
    ...
    public function update(Request $request,$id)
    {
        ...
        return $tag->response()->setStatusCode(200, "Tag Update Succefully");
    }
