...
class LessonController extends Controller
{
    ...
    public function show($id)
    {
        ...
        return $lesson->response()->setStatusCode(200, "Tag Returned Succefully")->header('Additional Header', 'True');
    }
    ...
    public function update(Request $request,$id)
    {
        ...
        return $lesson->response()->setStatusCode(200, "Lesson Update Succefully");
    }
